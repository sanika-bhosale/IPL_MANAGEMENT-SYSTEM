...
<div class="bag-image">
    ...
    <a href="Homelink.html ">Back</a></button>
<style >
    table{
...
<th>cap_number</th>
        ...
        {
          echo "<script type='text/javascript'>alert('Incorrect team name slect upper team only select onli MI RCB SRH CSK TEAMS ONLY !!');</script>";
          
          header("refresh: 0.01; url=Homelink.html");
        }
        else {
